...
public class ShaHashTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------");
        System.out.println("             SHA-1 HASH IMPLEMENTATION ");
        System.out.println("-------------------------------------------------");
        //Getting the word
        ...
        //Converting the word to binaryConvertedWord
        String binaryConvertedWord = convertToBinary(word);
        messLength = binaryConvertedWord.length();
        calculateMod(word, binaryConvertedWord);
...
//        e8bb27f03a6c0b3605b1d5382c64bb845354ae4c
//          e8bb27f03a6c0b3605b1d5382c64bb845354ae4c
