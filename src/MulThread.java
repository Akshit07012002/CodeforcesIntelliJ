...
class M2 implements Runnable
{
    public void run()
    {
        try
        {
            System.out.println("  ORIGINAL PRIORITY OF Thread " + Thread.currentThread().getName() + " with priority "
            ...
            System.out.println("  NEW PRIORITY OF Thread " + Thread.currentThread().getName() + " with priority "
                    + Thread.currentThread().getPriority() + " is running." );
